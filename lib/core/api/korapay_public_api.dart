...
class KoraPayPublicApi {
  final Dio _dio;
  KoraPayPublicApi(this._dio) {
    initializeDio();
  }
  ...
  requestInterceptors(RequestOptions requestOptions,
    ...
    requestOptions.headers.addAll({
      ...
      "Authorization": "Bearer pk_test_H9dvTBsBQK2Y7N49ut2KnKGmNvPsbuqZns8A5QSZ"
    });
  ...
  KoraPayPublicApi clone() => KoraPayPublicApi(_dio);
}
